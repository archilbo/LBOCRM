...
$ExpectedCommit = '9557060ab1d224c43993d6a1c6c7a8925749fe40'
...
$BackupRoot = Join-Path $ProjectRoot ('.repair-backups\projects-workspace-v1-1-' + $timestamp)
...
Write-Host ''
Write-Host 'PROJECTS WORKSPACE V1.1 APPLIED' -ForegroundColor Green
