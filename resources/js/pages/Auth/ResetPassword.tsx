            ...
            <main className="flex min-h-dvh items-center justify-center bg-[var(--surface)] px-4 py-8">
                <section className="w-full max-w-md rounded-2xl border border-[var(--border)] bg-[var(--surface-1)] p-6 shadow-2xl">
                    <div className="mb-6 flex items-start gap-3">
                        <div className="flex size-10 shrink-0 items-center justify-center rounded-xl bg-[var(--crm-gold-soft)] text-[var(--accent)]"><KeyRound size={18} /></div>
                        <div>
                    ...
                    <form onSubmit={submit} className="space-y-4">
                        ...
                        <p className="flex items-center gap-1.5 text-xs text-[var(--text-muted)]"><ShieldCheck size={13} className="text-[var(--crm-success)]" /> 12+ characters with uppercase, lowercase, number, and symbol.</p>
