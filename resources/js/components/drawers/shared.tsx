...
export const drawerStyles = {
  ...
  label:
    'text-[9px] font-semibold uppercase tracking-[0.08em] text-[var(--text-subtle)]',

  heading:
    'mb-2 flex items-center gap-1.5 text-[9px] font-semibold uppercase tracking-[0.08em] text-[var(--text-subtle)]',
...
export function DrawerError({ error }: { error?: string }) {
  ...
  return <p className="text-[9px] font-medium text-[var(--danger)]">{error}</p>;
}
