...
export function PlanningTimeline() {
    ...
    return (
        <AppCard className="min-w-0 p-4">
            <div className="mb-4">
                <h2 className="text-sm font-semibold">{t('planningWorkspace.timeline.title')}</h2>
                <p className="mt-1 text-sm text-[var(--text-muted)]">
                    {t('planningWorkspace.timeline.description')}
                </p>
            </div>
                ...
                {steps.map((step) => (
                    ...
                    >
                        ...
                        <p className="text-sm font-medium">
                            {t(`planningWorkspace.timeline.${step.key}`)}
                        </p>
                    </div>
                ))}
            </div>
