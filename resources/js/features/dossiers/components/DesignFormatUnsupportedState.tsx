        ...
        <div className="flex h-full flex-col items-center justify-center p-8">
            <div className="w-full max-w-sm rounded-xl border border-[var(--border)] bg-[var(--surface)] p-6 text-center">
                ...
                <div className="mt-3 flex justify-center gap-1.5">
                    {extension && (
                        <Chip size="sm" variant="flat" color="warning" className="h-5 text-[10px]">{extension.toUpperCase()}</Chip>
                    )}
                    {mimeType && (
                        <Chip size="sm" variant="flat" color="default" className="h-5 text-[10px]">{mimeType}</Chip>
                    )}
                </div>
                ...
                <div className="mt-4 rounded-lg border border-amber-200/50 bg-amber-50/50 px-4 py-3 text-left dark:border-amber-800/20 dark:bg-amber-900/5">
                    <div className="flex items-start gap-2">
                        ...
                        <p className="text-[11px] leading-relaxed text-amber-700 dark:text-amber-400">{displayMsg}</p>
                    </div>
                </div>
            </div>
        </div>
