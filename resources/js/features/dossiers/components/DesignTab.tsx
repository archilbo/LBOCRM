...
function DesignTabContent({ dossierId, urlState, onNavigate }: {
    dossierId: number; urlState?: { mode: string; file: string; version: string; remark: string }; onNavigate?: (updates: { mode?: string; file?: string; version?: string; remark?: string }) => void;
}) {
...
function DesignTab({ dossierId, canDesign, urlState, onNavigate }: {
    dossierId: number; canDesign?: boolean; urlState?: { mode: string; file: string; version: string; remark: string }; onNavigate?: (updates: { mode?: string; file?: string; version?: string; remark?: string }) => void;
}) {
    if (canDesign === false) {
