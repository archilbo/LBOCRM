...
import { Avatar, ProgressBar, Tooltip } from '@heroui/react';
    ...
    return (
        <>
            ...
            <div className="mt-1.5 flex items-center justify-between gap-2">
                ...
                {counts.length > 0 ? (
                    <span className="flex shrink-0 items-center gap-2 text-[9px] text-[var(--text-muted)]">
                        {counts.map((count) => (
            ...
            {task.status === 'blocked' && task.blockedReason ? (
                <div className="mt-1.5 flex items-start gap-1.5 rounded-lg border border-red-400/20 bg-red-400/10 px-2 py-1 text-[9px] leading-4 text-red-200">
