...
export { normalizeNumber, normalizeCurrency, formatMoney, formatFullMoney };

/**
 * Finance-specific compact money formatter with improved decimal handling.
 * Removes unnecessary decimal zeros for cleaner display.
 */
