...
import { IconChartBar, IconCalendarDue, IconCash, IconFileInvoice, IconFileText, IconLayoutDashboard, IconReceipt2, IconSettings2, IconShoppingCart, IconWallet } from '@tabler/icons-react';
...
export const financeTabs: AppWorkspaceTab[] = [
    ...
    { id: 'internals', label: 'Internes', icon: IconFileInvoice },
