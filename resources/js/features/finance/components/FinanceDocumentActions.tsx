...
export function createFinanceDocumentActions(
    ...
    const actions: Array<FinanceRowAction | false> = [
        ...
        can('finance.documents.create') && document.type === 'quote' && { id: 'convert', label: translate('finance.actions.convertToInvoice'), icon: <IconRefresh size={13} />, onPress: () => handlers.onConvert(document), tone: 'accent' },
        ...
        can('finance.payments.create') && document.type === 'invoice' && { id: 'payment', label: translate('finance.actions.registerPayment'), icon: <IconWallet size={13} />, onPress: () => handlers.onPayment(document), tone: 'success', dividerBefore: true },
