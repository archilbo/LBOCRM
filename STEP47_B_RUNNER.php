...
echo "STEP 47-B: Finance locked document numbers".PHP_EOL;

$timestamp = date('Y_m_d_His');

$migrationPath = "database/migrations/{$timestamp}_add_locked_number_columns_to_finance_tables.php";
...
write_file('app/Console/Commands/FinanceNumberingLockQaCommand.php', <<<'PHP'
<?php
...
run_cmd('php -l '.escapeshellarg($migrationPath));
run_cmd('php -l app/Services/Finance/FinanceDocumentNumberingService.php');
run_cmd('php -l app/Console/Commands/FinanceNumberingLockQaCommand.php');

run_cmd('php artisan optimize:clear');
run_cmd('php artisan migrate');
run_cmd('php artisan archilbo:finance-numbering-qa');
run_cmd('php artisan archilbo:finance-numbering-lock-qa');

echo PHP_EOL.'STEP 47-B completed.'.PHP_EOL;
