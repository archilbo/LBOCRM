# ARCHI LBO — Projects Workspace V1

## Target snapshot

```text
Branch: finance-template-editor
Commit: 4284dbf343e10fda511a81e565ba0d8fac03dfe1
```
...
```text
D:\ARCHI LBO\LBOSM\LBOCRM\_projects-workspace-v1
```
...
PowerShell.exe -ExecutionPolicy Bypass `
    -File .\_projects-workspace-v1\install-projects-workspace-v1.ps1
```
