...
echo "STEP 47-D: Finance export numbering discovery".PHP_EOL;

write_file('app/Console/Commands/FinanceExportNumberingDiscoveryCommand.php', <<<'PHP'
<?php
...
run_cmd('php -l app/Console/Commands/FinanceExportNumberingDiscoveryCommand.php');
...
run_cmd('php artisan archilbo:finance-export-numbering-discovery --write-report');

echo PHP_EOL.'STEP 47-D completed.'.PHP_EOL;